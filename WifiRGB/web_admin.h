  ...
  <main >
            ...
            <form>
              <div class="form-group">
                ...
                <p>Es sind max. 256 Messpunkte möglich. Kommazahlen: 0.1</p>
            ...
            <table>
              ...
              Restzeit: <span id="restZeit"></span> ms
    ...
    submitBtn.addEventListener("click",function(){
      ...
      if (Messmodus == 1){
          ...
          var counter = 0;
          var restzeit = setInterval(
            function(){
              counter = counter + 1;
              var Restzeit = MesszeitraumS-counter*MessaufloesungS/100;
              if (Restzeit < 0) {clearInterval(restzeit);}
              else{document.getElementById("restZeit").innerHTML = Restzeit;}
      ...
      if (Messmodus == 2){
          ...
          var restzeit = setInterval(
            function(){
              counterR = counterR + 1;
              var Restzeit = MesszeitraumR-counterR*MessaufloesungR/100;
              if (Restzeit < 0) {clearInterval(restzeit);}
              else{document.getElementById("restZeit").innerHTML = Restzeit;}
